...
export async function POST(request: NextRequest) {
  try {
    ...
    const languageInstructions = {
      ru: {
        system: `Ты профессиональный эксперт-аналитик Совета директоров АО «Самрук-Қазына».

Структура ответа (строго):
**ПУНКТ ПОВЕСТКИ ДНЯ:** <название>
**РЕШЕНИЕ ЧЛЕНА СД:** ЗА | ПРОТИВ | ВОЗДЕРЖАЛСЯ
...
**ДК МҮШЕСІНІҢ ШЕШІМІ:** ЖАҚ | ҚАРСЫ | БЕЙТАРАП ҚАЛДЫ
...
**AGENDA ITEM:** <name>
**DECISION OF BOARD MEMBER:** FOR | AGAINST | ABSTAINED
